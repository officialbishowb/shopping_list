...
/**
 * Sort comparison function to sort an object by "title" field
 * @param  {String} a
 * @param  {String} b
 * @returns {Number}
 */
...
var app = new Vue({
  ...
  computed: {
     ...
     * alphebetically by title
     *
     * @returns {Array}
     */
    sortedShoppingLists: function () {
      return this.shoppingLists.sort(byTitle);
    },

     /**
     * Calculates the shopping list items
     * alphebetically by title
     *
     * @returns {Array}
     */
     sortedShoppingListItems: function () {
      return this.shoppingListItems.sort(byTitle);
    },
  ...
  methods: {
    ...
    onAddListItem: function () {
      ...
      obj.quantity = this.itemQuantity || 1;
